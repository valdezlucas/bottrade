...
def run_permutation_test(csv_path="df_1d_joined.csv"):
    ...
    print("   Se espera que TODAS las metricas colapsen a aleatorio (PF <= 1.0, Expectancy < 0)")
    ...
    if not valid_folds:
        print("  ✅ ÉXITO: El modelo colapsó rápidamente. Ningún fold pudo encontrar un threshold válido.")
        print("  ✅ Esto confirma que el modelo original SI aprendía de la serie temporal estructurada.")
    else:
        ...
        if avg_expectancy > 0 and avg_pf > 1.0:
            ...
            print("  ¡Esto sugiere un DATA LEAKAGE fuerte en la calculacion del target o pnl/features!")
        else:
            print("\n  ✅ EXPECTATIVA CONFIRMADA: Las métricas del modelo falso son negativas.")
            print("  ✅ El edge del modelo original proviene de estructura real de mercado.")
